...
FW_OS_full_CP_2 <- dplyr::rename(FW_OS_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_full_CP_2 <- dplyr::rename(FW_WN_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_full_CP_2 <- dplyr::rename(FW_ST_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_full_CP_2 <- dplyr::rename(FW_ST.l_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_full_CP_2 <- dplyr::rename(FW_ST.h_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_full_CP_2 <- dplyr::rename(FW_ST.lh_full_CP_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
FW_OS_common_cat_PC_2 <- dplyr::rename(FW_OS_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_common_cat_PC_2 <- dplyr::rename(FW_WN_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_common_cat_PC_2 <- dplyr::rename(FW_ST_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_common_cat_PC_2 <- dplyr::rename(FW_ST.l_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_common_cat_PC_2 <- dplyr::rename(FW_ST.h_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_common_cat_PC_2 <- dplyr::rename(FW_ST.lh_common_cat_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
FW_OS_common_cat_CPL_2 <- dplyr::rename(FW_OS_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_common_cat_CPL_2 <- dplyr::rename(FW_WN_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_common_cat_CPL_2 <- dplyr::rename(FW_ST_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_common_cat_CPL_2 <- dplyr::rename(FW_ST.l_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_common_cat_CPL_2 <- dplyr::rename(FW_ST.h_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_common_cat_CPL_2 <- dplyr::rename(FW_ST.lh_common_cat_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
FW_OS_4plus_PC_2 <- dplyr::rename(FW_OS_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_4plus_PC_2 <- dplyr::rename(FW_WN_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_4plus_PC_2 <- dplyr::rename(FW_ST_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_4plus_PC_2 <- dplyr::rename(FW_ST.l_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_4plus_PC_2 <- dplyr::rename(FW_ST.h_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_4plus_PC_2 <- dplyr::rename(FW_ST.lh_4plus_PC_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
...
FW_OS_4plus_CPL_2 <- dplyr::rename(FW_OS_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "OS")
...
FW_WN_4plus_CPL_2 <- dplyr::rename(FW_WN_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "WN")
...
FW_ST_4plus_CPL_2 <- dplyr::rename(FW_ST_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST")
...
FW_ST.l_4plus_CPL_2 <- dplyr::rename(FW_ST.l_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.l")
...
FW_ST.h_4plus_CPL_2 <- dplyr::rename(FW_ST.h_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.h")
...
FW_ST.lh_4plus_CPL_2 <- dplyr::rename(FW_ST.lh_4plus_CPL_2, Locality_A = Var1, Locality_B = Var2, hodnota = value) %>%
  add_column(guild = "ST.lh")
